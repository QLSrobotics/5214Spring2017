...
@TeleOp(name="VuforiaCameraTesting", group ="Team5214")
//@Disabled
public class VuforiaCameraTesting extends LinearOpMode {

    VuforiaLocalizer vuforia; //calling vuforia class
    ...
    @Override public void runOpMode() throws InterruptedException{
        ...
        this.vuforia = ClassFactory.createVuforiaLocalizer(parameters); //hooking up parameter (camera) to the vuforia localizer
